...
function deHighlightCircles(){
  ...
  //instantaneous
  d3.selectAll("circle").each( function(c){d3.select(this).style("opacity",getCircleOpacity(c)).style("stroke",function(d){return getBubbleStrokeColor(this.getAttribute("viewed"),c.category)});}  );
}
