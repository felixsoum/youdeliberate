...
class ImageTest < ActiveSupport::TestCase
  ...
  test "UT-I-2: Should not save image without image_path or correct narrative id" do
  ...
  test "UT-I-1: Should have has_many relationship between narratives and images" do
